...
import time  # Sleep only
from micropython import const
from machine import I2C

from front.adafruit.i2c import I2CDevice

ReadableBuffer = bytearray
...
class CV:
    ...
    @classmethod
    def add_values(
        cls, value_tuples: list[tuple[str, int, str, float | None]]  # Iterable
    ) -> None:
