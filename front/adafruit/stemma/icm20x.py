...
from front.adafruit.i2c import I2CDevice, ROUnaryStruct, RWBit, ROBit, UnaryStruct, RWBits, Struct
...
class CV:
    ...
    @classmethod
    def add_values(cls, value_tuples: tuple[tuple] | list[tuple]) -> None:  # Iterable
    ...
    @classmethod
    def is_valid(
        cls, value: object#Union["AccelRange", "GyroRange", "GyroDLPFFreq", "AccelDLPFFreq"]
    ) -> bool:
...
class ICM20948(ICM20X):  # pylint:disable=too-many-instance-attributes
    ...
    **Quickstart: Importing and using the ICM20948 temperature sensor**
    ...
    def _read_mag_register(self, register_addr: int, slave_addr: int = 0x0C) -> int | None:
        self._bank = 3
